...
public class HexCalView {
    public static void main(String[] args) {
        JFrame frame = new JFrame();

        frame.setTitle("Hexadecimal Calculator");
...
////        frame.setVisible(true);
        ...
        JLabel text2 = new JLabel("Calculate Hexadecimal numbers:");
        text2.setBounds(5,10,300,20);

        JLabel text = new JLabel("Convert to Hex");
...
//        calculate.setBounds(75,50,50,30);
        ...
        b1.addActionListener(e -> {
            ...
            Hexadecimal newBin1 = new Hexadecimal(num1);
            Hexadecimal newBin2 = new Hexadecimal(num2);
            Number result = null;
